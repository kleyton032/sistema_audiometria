...
export const GRAU_DEFICIENCIA: Record<string, string[]> = {
  ...
  fisica: [
    ...
    'FMS: Nível 5',
    'FMS: Nível 6',
    'ÍNDICE DE BARTHEL: INDEPENDENCIA TOTAL',
    'ÍNDICE DE BARTHEL: SEVERA',
    'ÍNDICE DE BARTHEL: MODERADA',
    'ÍNDICE DE BARTHEL: LEVE',
    'ESCALA DE BERG: BAIXO RISCO DE QUEDAS',
    'ESCALA DE BERG: RISCO MODERADO DE QUEDAS',
    'ESCALA DE BERG: ALTO RISCO DE QUEDAS',
    'NÃO SE APLICA',
  ],
  auditiva: [
    'AUDIÇÃO NORMAL',
